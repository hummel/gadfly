...
class Units(object):
    def __init__(self, **unitargs):
        ...
        self.mass_unit = unitargs.pop('mass', 'solar')
        self.mass_conv = Masses[self.mass_unit]
        self.time_unit = unitargs.pop('time', 'yr')
        ...
        self.density_unit = unitargs.pop('density', 'cgs')
        self.density_conv = Densities[self.density_unit]
        self.pressure_unit = unitargs.pop('pressure', 'cgs')
        self.pressure_conv = Pressures[self.pressure_unit]
        self.energy_unit = unitargs.pop('energy', 'cgs')
